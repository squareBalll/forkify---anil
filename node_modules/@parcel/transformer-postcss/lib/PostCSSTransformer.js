...
var _default = new (_plugin().Transformer)({
  ...
  canReuseAST({
    ...
    return ast.type === 'postcss' && _semver().default.satisfies(ast.version, '^8.0.0');
  },
  ...
  async parse({
    ...
    let postcss = await options.packageManager.require('postcss', asset.filePath, {
  ...
  async transform({
    ...
    let {
      messages,
      root
    } = await postcss(plugins).process(ast.program, config.hydrated);
    ast.program = root;
    asset.setAST({
      type: 'postcss',
      version: '8.0.0',

...
function createAsset(options) {
  var _options$pipeline, _options$committed, _options$isIsolated, _options$isInline, _options$sideEffects;
...
async function getInvalidationHash(invalidations, options) {
  ...
  for (let invalidation of sortedInvalidations) {
    switch (invalidation.type) {
      case 'file':
        hash.update(await (0, _utils().md5FromFilePath)(options.inputFS, invalidation.filePath));
        break;

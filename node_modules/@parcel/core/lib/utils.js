...
function getPublicId(id, alreadyExists) {
  (0, _assert().default)(id.match(/^[0-9a-f]{32}$/), `id ${id} must be a 32-character hexadecimal string`);
...
'inputFS', 'outputFS', 'workerFarm', 'killWorkers', 'packageManager', 'detailedReport', 'disableCache', 'cacheDir', 'autoinstall', 'logLevel', 'profile', 'patchConsole', 'projectRoot']);
...
function hashFromOption(value) {
  if (typeof value === 'object' && value != null) {
    return (0, _utils().md5FromObject)(value);
  }

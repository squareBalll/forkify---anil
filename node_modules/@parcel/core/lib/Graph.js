...
class Graph {
  ...
  addNode(node) {
    ...
    this.nodes.set(node.id, existingNode !== null && existingNode !== void 0 ? existingNode : node);
    return node;
  }
  ...
  getNodesConnectedTo(node, type = null) {
    ...
    if (type === ALL_EDGE_TYPES) {
      ...
      nodes = (_inboundByType$get$va = (_inboundByType$get = inboundByType.get(type)) === null || _inboundByType$get === void 0 ? void 0 : _inboundByType$get.values()) !== null && _inboundByType$get$va !== void 0 ? _inboundByType$get$va : [];
    }
  ...
  getNodesConnectedFrom(node, type = null) {
    ...
    if (type === ALL_EDGE_TYPES) {
      ...
      nodes = (_outboundByType$get$v = (_outboundByType$get = outboundByType.get(type)) === null || _outboundByType$get === void 0 ? void 0 : _outboundByType$get.values()) !== null && _outboundByType$get$v !== void 0 ? _outboundByType$get$v : [];
    }
  ...
  removeNode(node) {
    ...
    for (let [type, nodesForType] of this.inboundEdges.getEdgesByType(node.id)) {
  ...
  isOrphanedNode(node) {
    ...
    if (rootNode == null) {
      ...
      // return false;
      for (let [, inboundNodeIds] of this.inboundEdges.getEdgesByType(node.id)) {

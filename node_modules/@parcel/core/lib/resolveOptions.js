...
async function resolveOptions(initialOptions) {
  ...
  return {
    ...
    mode,
    minify,
    autoinstall: (_initialOptions$autoi = initialOptions.autoinstall) !== null && _initialOptions$autoi !== void 0 ? _initialOptions$autoi : false,

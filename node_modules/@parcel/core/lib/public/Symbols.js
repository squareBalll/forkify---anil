...
class AssetSymbols {
  ...
  */
  ...
  hasExportSymbol(exportSymbol) {
    return (0, _nullthrows().default)(_classPrivateFieldGet(this, _value).symbols).has(exportSymbol);
  }
  ...
  exportSymbols() {
    // $FlowFixMe
    return _classPrivateFieldGet(this, _value).symbols.keys();
  } // $FlowFixMe
...
class MutableAssetSymbols {
  ...
  */
  ...
  hasExportSymbol(exportSymbol) {
    ...
    return Boolean((_classPrivateFieldGet3 = _classPrivateFieldGet(this, _value2).symbols) === null || _classPrivateFieldGet3 === void 0 ? void 0 : _classPrivateFieldGet3.has(exportSymbol));
  }
...
class MutableDependencySymbols {
  ...
  */
  ...
  hasExportSymbol(exportSymbol) {
    return (0, _nullthrows().default)(_classPrivateFieldGet(this, _value3).symbols).has(exportSymbol);
  }

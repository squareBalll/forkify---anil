...
function _logLevels() {
  const data = _interopRequireDefault(require("./logLevels"));
...
function _bundleReport() {
  const data = _interopRequireDefault(require("./bundleReport"));

  _bundleReport = function () {
    return data;
  };

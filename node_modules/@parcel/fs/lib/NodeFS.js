...
// require('fs').promises
const realpath = (0, _utils().promisify)(_gracefulFs().default.realpath);

class NodeFS {
  constructor() {
    _defineProperty(this, "readFile", (0, _utils().promisify)(_gracefulFs().default.readFile));

    _defineProperty(this, "copyFile", (0, _utils().promisify)(_gracefulFs().default.copyFile));

    _defineProperty(this, "stat", (0, _utils().promisify)(_gracefulFs().default.stat));

    _defineProperty(this, "readdir", (0, _utils().promisify)(_gracefulFs().default.readdir));

    _defineProperty(this, "unlink", (0, _utils().promisify)(_gracefulFs().default.unlink));

    _defineProperty(this, "utimes", (0, _utils().promisify)(_gracefulFs().default.utimes));
    ...
    _defineProperty(this, "createReadStream", _gracefulFs().default.createReadStream);

    _defineProperty(this, "cwd", process.cwd);

    _defineProperty(this, "chdir", process.chdir);

    _defineProperty(this, "statSync", _gracefulFs().default.statSync);

    _defineProperty(this, "realpathSync", _gracefulFs().default.realpathSync);

    _defineProperty(this, "existsSync", _gracefulFs().default.existsSync);

    _defineProperty(this, "readdirSync", _gracefulFs().default.readdirSync);
  }

...
var _default = new (_plugin().Transformer)({
  async loadConfig({
    ...
    if (result) {
      _utils().validateSchema.diagnostic(CONFIG_SCHEMA, result.contents, result.filePath, // FIXME
      await options.inputFS.readFile(result.filePath, 'utf8'), '@parcel/transformer-js', `/${(0, _diagnostic().encodeJSONKeyComponent)('@parcel/transformer-js')}`, 'Invalid config for @parcel/transformer-js');

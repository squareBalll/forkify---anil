  ...
  bundle.traverseAssets({
    ...
    exit(asset, context) {
      ...
      if (shouldSkipAsset(bundleGraph, bundle, asset)) {
        ...
        statements = (0, _utils().flat)([...context.children].sort(([aId], [bId]) => (0, _nullthrows().default)(statementIndices.get(aId)) - (0, _nullthrows().default)(statementIndices.get(bId))).map(([, ast]) => ast));
      } else {
        for (let [assetId, ast] of [...context.children].reverse()) {
          var _statementIndices$get;

          let index = (_statementIndices$get = statementIndices.get(assetId)) !== null && _statementIndices$get !== void 0 ? _statementIndices$get : 0;
